...
//for(int ti=0;ti<4;ti++){for(int tj=0;tj<4;tj++){std::cout << tM[ti][tj] << " ";}std::cout<<"\n";}std::cout<<"\n";
		...
		switch(curText) {
		  ...
		  case 1:
			...
			gubo.lightDir0 = glm::vec3(-0.4830f, 1.8365f, -0.2588f);
		  ...
		  case 2:
			...
			gubo.lightDir0	 = glm::vec3(cos(glm::radians(135.0f)) * cos(glm::radians(-60.0f)), 3+sin(glm::radians(135.0f)), 	cos(glm::radians(135.0f)) * sin(glm::radians(-60.0f)));
			break;
		  case 3:
